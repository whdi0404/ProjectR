...
namespace M4u
{
	...
	{
		private static readonly string IconSearchName = "icon_b_0";
		private static readonly int IconCount = 26;
		private static readonly string IconPrefsKey = "m4u_show_hierarchy_icon";

		private static string resPath;
		private static string[] iconPaths = { "{0}/icon_r_{1}.png", "{0}/icon_b_{1}.png" };
		...
		private static string GetResPath(DirectoryInfo current)
		{
